...
class ConfigManager:
    ...
    def interactive_setup(self):
        ...
        # Camera configuration - gphoto2 USB only
        # Note: Canon WiFi/CCAPI is not supported - use USB connection with gphoto2
        config['camera_type'] = 'gphoto2'
        print("\n📷 Camera: USB connection via gphoto2")
        print("   Ensure camera is set to PTP/MTP USB mode (not Mass Storage)")
    ...
    def print_config(self):
        ...
        print(f"\nCamera: USB via gphoto2 (Canon R100)")
